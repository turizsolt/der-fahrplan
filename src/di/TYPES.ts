export const TYPES = {
    ...
    FactoryOfWagonRenderer: Symbol.for('Factory<WagonRenderer>'),
    ...
    FactoryOfWaitingHall: Symbol.for('Factory<WaitingHall>'),
    FactoryOfWaitingHallRenderer: Symbol.for('Factory<WaitingHallRenderer>'),
